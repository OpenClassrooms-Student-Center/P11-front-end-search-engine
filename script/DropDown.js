...
generateItems(tab, domBlock, type)
{
  ...
  displayItem(types, filteredRecipe) {
          ...
          this.inputIngredient.oninput = (e) => {
            ...
            this.recipes.forEach((recipe) => {
              ...
              recipeIngredients.forEach((ingredients) => {
                ...
                if (!tableauIngredients.includes(ingredient)) {
                  tableauIngredients.push(ingredient);
                  return  this.generateItems(itemToDisplay,this.dropIngredient, "ingredients" )
                }
                  itemToDisplay = tableauIngredients.filter(item => item.startsWith(e.target.value))
                  this.removeListItem("ingredients") 
                  this.generateItems(itemToDisplay,this.dropIngredient, "ingredients" )
          ...
          .forEach((ingredientsList) => {
            ingredientsList.addEventListener("click", (e) => {
              ...
              console.log(currentItem)
                this.buildBadges(this.tags, currentItem, "ingredient");
                console.log(this.tags)
                // fermeture du badge
                document
