...
/* ======================== START - DOM =====================  */ const searchBar = document.getElementById('inputSearch');
const searchBarIngredient = document.getElementById('filterFoodInput');
let searchResult = [];
let ingredientResults = [];
/* ======================== END - DOM =====================  */ /* ======================== START - Algorithme =====================  */ // function qui build depuis le template les card de recette, 
const renderRecipe = (recipes)=>{
    ...
    recipes.map((recipe)=>{
        ...
        /* const recipeIngredients = clone.querySelector('#recipeIngredients'); */ const recipeIngredientsList = clone.querySelector('#recipeIngredientsList');
        /* const recipeQuantities = clone.querySelector('#recipeQuantities'); */ const recipeDetail = clone.querySelector('#recipeDetail');
...
} */ /* ======================== END - Filters =====================  */ const filterByName = (recipes, filtre)=>recipes.filter((recipe)=>recipe.name.toLowerCase().includes(filtre.toLowerCase())
    )
;
...
function searchByName() {
    if (searchBar.value.length >= 3) {
        const results = onSearch(recipes1, searchBar.value);
        /**** NEXT *****/ // const currentIngredients = getIngredients(results) // ['coco', 'poulet', ...]
        // renderFilter(currentIngredients)
        searchResult = results;
        render(results);
    } else if (searchBar.value.length <= 2) renderRecipe(recipes1);
}
...
/**** NEXT *****/ // 3 champs filtre => Ajout d'un filtre => Creation d'un Tag => Trigger de la fonction de filtrage
...
/* ======================== END - Algorithme =====================  */ render(recipes1) // render initial au chargement de la page
;

//# sourceMappingURL=index.2b0bed13.js.map
